class GovernanceLLMPrompts:
    ...
    =====================================================================
    [PII TAG & SENSITIVITY LEVEL SPECIFICATIONS]
    Use the following rules to classify columns in Category 2. Match the semantic meanings, column name prefixes/suffixes, and sample data shapes:
    ...
    1. RESIDENT_ID (Sensitivity: HIGH)
       ...
       - Sample Data Patterns: 12-digit numbers (modern CCCD), 9-digit numbers (legacy CMND), or alphanumeric strings.
    ...
    7. NAME (Sensitivity: MEDIUM)
       ...
       - Column Name Cues: 'ten', 'ho_ten', 'fullname', 'name', 'chu_ho_so', 'sender', 'receiver'.
    ...
    4. Finality Principle: You must make a clear decision for every column. Do not use generic placeholders.
